...
def build_payload() -> dict:
    ...
    # Claims that are useful for the research queue but are not yet bank-grade
    # facts.  Keep these explicit instead of silently promoting a proxy,
    # forecast or an open request to a verified market figure.  The dashboard
    # renders this collection in its own view so that a reviewer can see the
    # confidence, source state and next verification route at a glance.
    unverified_sources = [
        {
            "id": "PX-CA-SALES-2025",
            "market": "Kanada",
            "claim": "Health Canadan vuoden 2025 toimitusmyynti (CAD, yksiköt ja litrat)",
            "value": "Ei vielä julkaistu / vahvistettu",
            "evidenceType": "Viranomaispyyntö",
            "sourceStatus": "pending",
            "confidence": 35,
            "source": "Health Canada · Vaping sales",
            "sourceUrl": "https://health-infobase.canada.ca/substance-use/vaping/sales/",
            "nextVerification": "PX-CA-002: pyydä 2025–nykyhetki, latausformaatti ja sarjan menetelmämuutokset.",
            "contactId": "PX-CA-002",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-KR-LIQUID-HSK10",
            "market": "Etelä-Korea",
            "claim": "HSK10-koodien 2404121000 ja 2404199010 erilliset nesteiden tuontiarvot",
            "value": "HS6-proxy 123,731 milj. USD; jako puuttuu",
            "evidenceType": "Tulliproxy",
            "sourceStatus": "partial",
            "confidence": 55,
            "source": "Korea Customs Service / Itemtrade",
            "sourceUrl": "https://tradedata.go.kr/cts/index_eng.do",
            "nextVerification": "PX-KR-001: hanki HSK10-kuukausisarja arvolle, painolle ja alkuperämaalle.",
            "contactId": "PX-KR-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-CN-HS8-2025",
            "market": "Kiina",
            "claim": "GACC:n 2025 HS8-tuonti ja vienti nimikkeillä 85434000, 24041200, 24041910 ja 24041990",
            "value": "Lukua ei ole vielä saatu",
            "evidenceType": "Avoin viranomaisreitti",
            "sourceStatus": "pending",
            "confidence": 20,
            "source": "China Customs · Online Customs Statistics",
            "sourceUrl": "https://online.customs.gov.cn/static/pages/guides/002029004002/002029004002.html",
            "nextVerification": "PX-CN-001: vahvista kiinankielinen hakemus ja pyydä partneri-, tullimenettely- ja kotimaisen alueen taulukot.",
            "contactId": "PX-CN-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-IT-PLI-2023-2025",
            "market": "Italia",
            "claim": "PLI-nesteiden toteutunut 2023–2025 kuukausivolyymi ja maksettu vero",
            "value": "Verokannat vahvistettu; toteumasarja puuttuu",
            "evidenceType": "Raportointimalli + tietopyyntö",
            "sourceStatus": "pending",
            "confidence": 40,
            "source": "Agenzia delle Dogane e dei Monopoli (ADM)",
            "sourceUrl": "https://www.adm.gov.it/portale/-/portale-prodotti-liquidi-da-inalazione-pli-e-prodotti-accessori-dei-tabacchi-pat-1",
            "nextVerification": "PX-IT-001: pyydä toteutuneet pakkaukset, ml, palautukset ja varastosiirrot erillisinä.",
            "contactId": "PX-IT-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-ES-L1-L2-2025",
            "market": "Espanja",
            "claim": "Modelo 573:n L1/L2-e-nesteiden millilitrat vuoden 2025 huhti–joulukuussa",
            "value": "29,568 milj. EUR yhdistetty vero on varmistettu; ml-solut puuttuvat",
            "evidenceType": "Veroaggregaatin rajaus",
            "sourceStatus": "partial",
            "confidence": 60,
            "source": "AEAT / BOE Modelo 573",
            "sourceUrl": "https://www.boe.es/eli/es/o/2025/01/13/hac86",
            "nextVerification": "PX-ES-001: toimita virallinen sähköinen pyyntö L1/L2-ml, L3/L4-g, palautukset ja oikaisut.",
            "contactId": "PX-ES-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-FR-ANSES-2018-2025",
            "market": "Ranska",
            "claim": "ANSES/EU-CEG:n vuosittaiset myyntiyksiköt, täyttömillilitrat ja ilmoituskattavuus 2018–2025",
            "value": "Rekisteri 203 181 riviä; myyntivuosidata puuttuu",
            "evidenceType": "Rekisteri (ei myyntiä)",
            "sourceStatus": "partial",
            "confidence": 50,
            "source": "ANSES EU-CEG",
            "sourceUrl": "https://www.data.gouv.fr/en/datasets/produits-du-tabac-et-produits-connexes-declares-sur-le-marche-francais/",
            "nextVerification": "PX-FR-001: pyydä vuosittaiset expected/submitted-rivit, yksiköt ja ml:t ilman yritystietoja.",
            "contactId": "PX-FR-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-NL-VWS-MODEL",
            "market": "Alankomaat",
            "claim": "VWS:n tilaama kulutusmenomalli 281,548 milj. EUR",
            "value": "281,548 milj. EUR (mallinnettu, ei sell-out)",
            "evidenceType": "Tutkimusmalli",
            "sourceStatus": "unverified",
            "confidence": 45,
            "source": "VWS / Bureau Beke · Donkere wolken",
            "sourceUrl": "https://www.tweedekamer.nl/downloads/document?id=2026D17119",
            "nextVerification": "PX-NL-001: pyydä laskentasolut, painot, SPSS-syntaksi ja EU-CEG-myyntivertailu.",
            "contactId": "PX-NL-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-SE-FHM-2021-2025",
            "market": "Ruotsi",
            "claim": "FHM:n EU-CEG-vuosittaiset laite-, podi- ja täyttöpullomyyntimäärät 2021–2025",
            "value": "26 000 litran verovolyymi 2024 vahvistettu; sell-out puuttuu",
            "evidenceType": "Veroankkuri + avoin pyyntö",
            "sourceStatus": "partial",
            "confidence": 65,
            "source": "Public Health Agency of Sweden (FHM)",
            "sourceUrl": "https://www.folkhalsomyndigheten.se/anmal-och-rapportera/anmala-ansoka-rapportera-och-registrera-tobaks-och-nikotinprodukter/anmala-ingredienser-i-e-cigaretter-och-pafyllningsbehallare/",
            "nextVerification": "PX-SE-001: pyydä tuotetyyppi-, yksikkö-, ml- ja kattavuuskentät vuosilta 2021–2025.",
            "contactId": "PX-SE-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-DK-LIQUID-TAX-2025",
            "market": "Tanska",
            "claim": "Nikotiininesteiden erillinen verollinen ml-määrä vuoden 2025 yhdistelmätilistä",
            "value": "789,133 milj. DKK yhdistetty tili; e-nesteosuus puuttuu",
            "evidenceType": "Yhdistetty verototeuma",
            "sourceStatus": "partial",
            "confidence": 55,
            "source": "Danish Ministry of Taxation / Skattestyrelsen",
            "sourceUrl": "https://skm.dk/tal-og-metode/statistik/indtaegtslister/indtaegtsliste-for-2025",
            "nextVerification": "PX-DK-002: pyydä ml:t vahvuusryhmittäin, brutto/palautus/netto sekä täsmäytys 90 milj. DKK ennusteeseen.",
            "contactId": "PX-DK-002",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-UK-TRPR-2022-CURRENT",
            "market": "Yhdistynyt kuningaskunta",
            "claim": "TRPR 32 -vuosiraporttien koottu e-savukemyynti 2022–nykyhetki",
            "value": "Julkista kokonaislukua ei ole vielä vahvistettu",
            "evidenceType": "Viranomaispyyntö",
            "sourceStatus": "pending",
            "confidence": 15,
            "source": "MHRA",
            "sourceUrl": "https://www.gov.uk/guidance/e-cigarettes-and-vapes-overview",
            "nextVerification": "PX-UK-001: pyydä anonymisoitu vuosiyhteenveto TRPR Regulation 32 -raportoinnista.",
            "contactId": "PX-UK-001",
            "lastChecked": "2026-07-17",
        },
        {
            "id": "PX-AU-VAPE-2024-CURRENT",
            "market": "Australia",
            "claim": "Vaping-tuotteiden julkaistu kansallinen myynti- ja hintasarja 2024–nykyhetki",
            "value": "Julkista kokonaislukua ei ole vielä vahvistettu",
            "evidenceType": "Viranomaispyyntö",
            "sourceStatus": "pending",
            "confidence": 15,
            "source": "Australian Department of Health",
            "sourceUrl": "https://www.health.gov.au/topics/smoking-and-tobacco/tobacco-control",
            "nextVerification": "PX-AU-001: pyydä kansallinen koonti ja määritelmät laitteille, nesteille ja myyntikanaville.",
            "contactId": "PX-AU-001",
            "lastChecked": "2026-07-17",
        },
    ]
    ...
    data = {
        ...
        "contacts": contacts,
        "unverifiedSources": unverified_sources,
        "tasks": [
